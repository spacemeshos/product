...
4. In Windows 10, if the app was installed then uninstall it by running `Uninstall Spacemesh.exe`. It is located in the App install folder. The deafult is: `C:\Users\[your_user_name]\AppData\Local\Programs\Spacemesh`
...
3. In Windows 10, if the app was installed then uninstall it by running `Uninstall Spacemesh.exe`. It is located in the App install folder. The deafult is: `C:\Users\[your_user_name]\AppData\Local\Programs\Spacemesh`
